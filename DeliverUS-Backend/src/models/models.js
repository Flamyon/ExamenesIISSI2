...
import loadStaffModel from './Staff.js'
...
const Staff = loadStaffModel(sequelizeSession, Sequelize.DataTypes)

const db = { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Staff }
...
export { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Staff, sequelizeSession }
